...
A Container for [FastChat](https://github.com/lm-sys/FastChat)

- GitHub: [https://github.com/entelecheia/fastchat-container][repo-url]

This repository provides a Docker container for running [FastChat](https://github.com/lm-sys/FastChat) easily.
...
After starting the container, you can access the application at `localhost:<APP_HOST_WEB_SVC_PORT>`. By default, the port is set to `18000`.
...
<!-- Links: -->
[license-image]: https://img.shields.io/github/license/entelecheia/fastchat-container
[license-url]: https://github.com/entelecheia/fastchat-container/blob/main/LICENSE
[version-image]: https://img.shields.io/github/v/release/entelecheia/fastchat-container?sort=semver
[release-date-image]: https://img.shields.io/github/release-date/entelecheia/fastchat-container
[release-url]: https://github.com/entelecheia/fastchat-container/releases
[repo-url]: https://github.com/entelecheia/fastchat-container
[changelog]: https://github.com/entelecheia/fastchat-container/blob/main/CHANGELOG.md
[contributing guidelines]: https://github.com/entelecheia/fastchat-container/blob/main/CONTRIBUTING.md
<!-- Links: -->
